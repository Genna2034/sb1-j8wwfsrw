/*
  # Schema initialization for Emmanuel Cooperativa

  1. Utility Functions
    - handle_updated_at: Updates the updated_at timestamp on record changes
    - handle_notifications_read_at: Updates read_at timestamp when a notification is marked as read
...
-- Funzione per aggiornare il timestamp 'read_at' delle notifiche
DROP FUNCTION IF EXISTS public.update_notifications_read_at() CASCADE;
...
-- ========= TRIGGERS =========
-- Applica la funzione 'update_updated_at_column' a tutte le tabelle che ne hanno bisogno
...
-- Applica la funzione 'update_notifications_read_at'
