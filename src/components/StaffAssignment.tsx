...
// Get staff category based on position - moved outside component to be accessible globally
...
// Get color for staff category - moved outside component to be accessible globally
...
// Utility function to calculate duration between two time strings - moved outside component
